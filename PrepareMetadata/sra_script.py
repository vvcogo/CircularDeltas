...
def create_pattern_models(file,changes_models_dict,platform_model_dict,changes_models_dict):
    aux = []
...
def main(argv):
    ...
    #runing the script normaly to create the results
        ...
        final_count = create_pattern_models(filtered_df,changes_models_dict,platform_model_dict,changes_models_dict).groupby(['Platform','Model']).count()
